...
public interface ParametroInterfazKey {
     ...
     * @param cuenta
     * @return
     *     returns pe.bn.com.sate.ope.transversal.ws.comp.SistemaParametro
     */
    @WebMethod(action = "datoParametroService")
    @WebResult(name = "datoParametroServiceReturn", targetNamespace = "")
    @RequestWrapper(localName = "datoParametroService", targetNamespace = "http://service.ws.comp.bn.com.pe", className = "pe.bn.com.sate.ope.transversal.ws.comp.DatoParametroService")
    @ResponseWrapper(localName = "datoParametroServiceResponse", targetNamespace = "http://service.ws.comp.bn.com.pe", className = "pe.bn.com.sate.ope.transversal.ws.comp.DatoParametroServiceResponse")
